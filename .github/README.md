...
[`@aws-sdk/client-lookoutequipment`](https://www.npmjs.com/package/@aws-sdk/client-lookoutequipment/v/3.821.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-lookoutequipment@3.821.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-OFAy3TX5+U1/VBjYsvp6n6h7ORReVC86mTRUOtgXzH+w4MaqvSH8QWWInb+otE+w
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-lookoutequipment": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-lookoutequipment@3.821.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-lookoutequipment@3.821.0/index.min.mjs": "sha384-OFAy3TX5+U1/VBjYsvp6n6h7ORReVC86mTRUOtgXzH+w4MaqvSH8QWWInb+otE+w"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-lookoutequipment/blob/refs/tags/3.821.0/LICENSE
```
